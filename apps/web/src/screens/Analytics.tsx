...
export function Analytics({
  ...
  /**
   * Размер кольца один на все периоды.
   *
   * Подгонять его под длину списка казалось разумным, но выглядит как поломка:
   * переключил период — и картинка прыгнула. Длинный список пусть лучше
   * прокручивается, чем скачет главный элемент экрана.
   */
